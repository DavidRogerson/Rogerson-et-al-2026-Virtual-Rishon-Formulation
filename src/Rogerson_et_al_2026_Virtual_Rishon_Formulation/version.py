...
"""
# Copyright (C) TeNPyExtension Developer, Apache license
# This file is part of the tenpy_extensions package
...
__all__ = [
    "__version__", "version", "released", "short_version", "git_revision", "full_version", "version_summary"
]
__version__ = "0.1.0"
...
def _get_version_summary():
    import tenpy
    from tenpy.tools.optimization import have_cython_functions, compiled_with_MKL
    import numpy
    import scipy
    ...
    summary = ( "tenpy_extensions version {version!s},\n"
                "git revision {git_rev!s} using\n"
                "tenpy {tenpy_ver!s} ({cython_info!s}), git revision {tenpy_git_rev!s}\n"
                "python {python_ver!s}\n"
                "numpy {numpy_ver!s}, scipy {scipy_ver!s}")
    summary = summary.format(
                                version=full_version,
                                git_rev=git_revision,
                                tenpy_ver=tenpy.version.full_version,
                                cython_info=cython_info,
                                tenpy_git_rev=tenpy.version.git_revision,
